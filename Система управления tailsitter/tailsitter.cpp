...
/**
 * @class Tailsitter
 * @brief Class for controlling the tailsitter VTOL type.
 *
 * The Tailsitter class is responsible for controlling the transition between multicopter (MC) mode
 * and fixed-wing (FW) mode in a tailsitter vehicle, as well as handling the attitude and thrust control during transitions.
 */
...
/**
 * @brief Update VTOL parameters.
 *
 * This function updates the parameters specific to the tailsitter.
 */
...
/**
 * @brief Update the VTOL state.
 *
 * This function determines whether the vehicle should be in multicopter (MC) mode, fixed-wing (FW) mode,
 * or transitioning between the two, based on user input or system state.
 */
 ...
 *
 * This function controls the vehicle's behavior during transitions between multicopter
 * and fixed-wing modes, including setting attitude and thrust setpoints.
 */
...
/**
 * @brief Manage the TECS (Total Energy Control System) state.
 *
 * This function is called when the vehicle is waiting on TECS updates during a transition.
 */
...
/**
 * @brief Update the fixed-wing state.
 *
 * This function is called when the vehicle is in fixed-wing mode to handle fixed-wing specific control.
 */
...
/**
 * @brief Write actuator outputs.
 *
 * This function writes the calculated torque and thrust setpoints to the actuator output topics, depending on the current mode.
 */
...
/**
 * @brief Check if the front transition is completed.
 *
 * This function determines whether the vehicle has completed the transition to fixed-wing mode.
 *
 * @return true if the transition to fixed-wing mode is completed, false otherwise.
 */
